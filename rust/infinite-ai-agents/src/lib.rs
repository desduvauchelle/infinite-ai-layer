...
use infinite_ai_core::{
    ...
    AvailabilityReason, Capability, ConnectionInfo, Cost, DataBoundary, ErrorCode, EventStream,
    FinishReason, HealthResult, ModelInfo, ProviderAdapter, StreamEvent, StructuredOutputSupport,
    TextRequest, TextResult, Usage,
};
